      ...
      <div className="w-full max-w-5xl mx-auto mt-10 px-4">
        <div className="bg-white rounded-2xl shadow-xl border border-[#e0d6ca] p-6 md:p-10">
          <h2 className="text-2xl font-semibold mb-6 text-[#5f4b32] flex items-center gap-2">
            <UserPlus className="w-6 h-6" /> Crear nuevo usuario
          </h2>

          {mensajeExito && (
            <div className="bg-green-100 border border-green-300 text-green-700 px-4 py-2 rounded mb-4 text-base text-center">
              {mensajeExito}
            </div>
          )}

          {mensajeError && (
            <div className="bg-red-100 border border-red-300 text-red-700 px-4 py-2 rounded mb-4 text-base text-center">
              {mensajeError}
            </div>
          )}
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#b89b71] text-white py-3 rounded hover:bg-[#9e855c] text-base font-medium"
            >
              Crear usuario
            </button>
          </div>
