...
const ForgotPasswordPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fdf8f4] px-4">
      <div className="bg-white p-8 rounded-2xl shadow-md w-full max-w-md border border-[#e0d6ca]">
        <div className="w-24 h-24 mx-auto mb-6">
          <IconoLogo className="w-full h-full" />
        </div>

        <h1 className="text-2xl font-semibold mb-4 text-center text-[#5f4b32]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-[#b89b71]"
          />
        ...
        <div className="mt-6 text-center">
          <Link to="/login" className="text-sm text-[#5f4b32] hover:underline">
